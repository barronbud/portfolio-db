...
import { Completeoms_Customer, Relatedoms_CustomerModel, Completeoms_OrderItem, Relatedoms_OrderItemModel } from "./index"
 ...
 */
export const Relatedoms_OrderModel: z.ZodSchema<Completeoms_Order> = z.lazy(() => oms_OrderModel.extend({
